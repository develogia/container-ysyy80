...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ysyy80.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ysyy80.containers.anotherwebservice.com/
...
```
git clone git@github.com:develogia/container-ysyy80.git
cd container-ysyy80
```
...
```
docker attach container-ysyy80
```
